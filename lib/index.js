    ...
    constructor(props) {
        ...
        this.renderSkippedLineIndicator = (num, blockNumber, leftBlockLineNumber, rightBlockLineNumber) => {
            ...
            return (React.createElement("tr", { key: `${leftBlockLineNumber}-${rightBlockLineNumber}`, className: this.styles.codeFold },
                ...
                React.createElement("td", { className: cn({ [this.styles.codeFoldGutter]: !splitView }) }),
        ...
        this.renderDiff = () => {
            ...
            const { lineInformation, diffLines } = computeLineInformation(oldValue, newValue, disableWordDiff, compareMethod);
        ...
        this.render = () => {
            ...
            return (React.createElement("table", { className: cn(this.styles.diffContainer, { [this.styles.splitView]: splitView }) },
